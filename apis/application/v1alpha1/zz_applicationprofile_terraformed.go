...
func (mg *ApplicationProfile) GetTerraformResourceType() string {
	return "aci_application_profile"
}
...
func (tr *ApplicationProfile) GetObservation() (map[string]interface{}, error) {
...
func (tr *ApplicationProfile) SetObservation(obs map[string]interface{}) error {
...
func (tr *ApplicationProfile) GetParameters() (map[string]interface{}, error) {
...
func (tr *ApplicationProfile) SetParameters(params map[string]interface{}) error {
